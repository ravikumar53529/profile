...
export class ReportsService {
    ...
    public commonPath='assets/admin/data/reports'
    ...
    public getReportHeadingsData(endpoint:string):Observable<any>{
        return this.httpClientRef.get(`${this.commonPath}/${endpoint}.json`)
    }
}
