...
import { Customheaders } from 'src/app/admin/features/airlinebooking/interfaces/customheaders';
...
export class DailyreportComponent implements OnInit, OnDestroy {
  ...
  public addingDefaultHeaders(): void {
    this.customizedHeadersSubscription$ = this.reportsServiceRef.gettingCustomizedHeaders().subscribe((data: Customheaders[]) => {
